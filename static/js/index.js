...
containerNode.addEventListener('click', (event) => {
   ...
   const buttonCoords = findCooridnatesByNumber(buttonNumber, matrix);
   const blankCoords = findCooridnatesByNumber(blankNumber, matrix);
...
function findCooridnatesByNumber(number, matrix) {
    for(let y = 0; y < matrix.length; y++) {
        for(let x = 0; x < matrix[y].length; x++) {
